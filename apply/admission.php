...
if (isset($_POST["btnsubmit"])) {
  ...
  if (mysqli_num_rows($res_u) > 0) {
    ...
    if (mysqli_num_rows($res_u) > 0) {
      ...
      $sql = "INSERT INTO admission (fullname,sex,phone,email,password,lga,state,passport_number,grade_score,faculty,dept,proficiency_test,ssce,status,photo,date_admission,applicationID)VALUES( '$fullname','$sex','$phone','$email','$password','$country','$state','$jambno','$jambscore','$faculty','$dept','$exam','$credential','$status','$photo','$current_date','$applicationID')";
          ...
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-lg-12 control-label" for="pass1">Country:
                <input type="text" id="pass1" class="form-control" name="txtcountry" value="<?php if (isset($_POST['txtcountry'])) ?><?php echo $_POST['txtstate']; ?> " required="">
              </label>
            </div>
            <div class="form-group">
