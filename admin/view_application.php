  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
     <a href="#" class="brand-link">
      <img src="../images/logo.jpg" alt=" Logo" width="130" height="80" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block text-white"><?php echo $row['username'];  ?></a>
        </div>
      </div>
        ...
        <div class="row">
		 ...
		 <!-- general form elements -->
            ...
            <div class="card-body">
                                    ...
                                    <?php 
                                    $select = "SELECT * FROM `documents`,admission where documents.reason='application' and admission.id='".$_GET['uid']."'";
